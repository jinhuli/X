            ...
            for i in range(len(soup2)):
                if len(soup2[i].find_all("span")) < 8:
                    ...
                    pddata.loc[i] = [
                        soup2[i].find_all("span")[1].text[0:4],
                        soup2[i].find_all("span")[1].text[5:],
                        soup2[i].find_all("span")[2].text[-10:],
                        soup2[i].find_all("span")[-4].text[3:],
                        soup2[i].find_all("span")[-3].text[3:],
                        soup2[i].find_all("span")[-2].text[3:],
                        soup2[i].find_all("span")[-1].text[3:]]
                    #print(soup2[i])
